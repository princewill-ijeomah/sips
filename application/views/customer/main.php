...
<html>
	...
	<body class="loading-overlay-showing" data-plugin-page-transition data-loading-overlay data-plugin-options="{'hideDelay': 500}">
				...
				<div class="header-body border-color-primary header-body-bottom-border">
						...
						<div class="container">
							<div class="header-row py-2">
								<div class="header-column justify-content-start">
									<div class="header-row" id="topbar_container">
					...
					<div class="header-container container">
						<div class="header-row">
							...
							<div class="header-column justify-content-end">
								<div class="header-row" id="navbar_container">
		...
		<script src="<?= base_url() ?>assets/eksternal/vendor/rs-plugin/js/jquery.themepunch.tools.min.js"></script>
		<script src="<?= base_url() ?>assets/eksternal/vendor/rs-plugin/js/jquery.themepunch.revolution.min.js"></script>
